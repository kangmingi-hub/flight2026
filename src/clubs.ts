...
// Blossom coords (1408x768) - verified
...
// For other clubs - same layout style, use blossom coords as base
// You can fine-tune per club later
const campusCoords: OverlayCoords = blossomCoords;

// BPM / EBS have slightly different layout (no 활동보고/보고수 labels)
const bpmCoords: OverlayCoords = {
  evHyun:  [30.18, 40.76, 6.39, 3.91],
  evMok:   [30.18, 45.57, 6.39, 3.65],
  evBogo:  [24.15, 51.82, 12.43, 3.26],
  effHyun: [82.03, 40.76, 6.61, 3.91],
